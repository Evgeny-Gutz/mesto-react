    ...
    <>
        ...
        <PopupWithForm 
            ...
            onClose={closeAllPopups}>
                ...
                <input className="popup__submit" type="submit" name="submit" value="Сохранить"></input></PopupWithForm>
        <PopupWithForm 
            name="card" 
            title="Новое место" 
            ...
            onClose={closeAllPopups}>
                <label className="popup__field">
                 ...
                 <input className="popup__submit" type="submit" name="submit" value="Создать"></input></PopupWithForm> 
        <PopupWithForm 
            name="avatar" 
